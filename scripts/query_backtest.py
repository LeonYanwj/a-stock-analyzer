...
用法:
    python -m scripts.query_backtest                       # 列出最近 20 次回测
    python -m scripts.query_backtest --strategy swing      # 只列 swing 策略的
    python -m scripts.query_backtest --run 5               # 查看第 5 次回测详情
    python -m scripts.query_backtest --run 5 --picks       # 查看第 5 次的持仓明细
    python -m scripts.query_backtest --compare 3 5 7       # 对比多次回测
"""
import sys
import io
import argparse
