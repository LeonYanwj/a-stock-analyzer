...
用法:
    python -m astock.backtest_simple                       # 默认 6 个月、300 只
    python -m astock.backtest_simple --months 6 --limit 500 --strategy swing
    python -m astock.backtest_simple --strategy short_term --top 30
"""
import sys
import io
import os
...
def save_backtest_to_db(strategy_name: str, start_date, end_date,
    ...
    """
    try:
        from astock.data.db import (get_conn, get_strategy, create_backtest_run,
...
def main():
    ...
    if run_id:
        try:
            from astock.data.db import (get_conn, finalize_backtest_run,
