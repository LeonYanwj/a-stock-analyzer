...
用法:
    python -m astock.screen                       # 全部主板
    python -m astock.screen --limit 200           # 只跑前 200 只（试跑）
    python -m astock.screen --top 30 --lookback 90
"""
import sys
import io
import os
...
from astock.data.fetcher import DataFetcher
from astock.universe import get_universe
from astock.factors import compute_all_factors
from astock.selector import score, top_n
from astock.news_scorer import compute_news_score
from astock.financial_risk import attach_financial_risk
from astock.market_data_integrity import ensure_unique_panel, one_row_per_ts_code
from astock.rating_store import prepare_snapshot, save_snapshot
from astock.strategies import (get_factor_weights, list_strategies,
