...
from .signal_providers import SignalProviderError, VnpyAlphaSignalProvider
...
class TradeRunPlanner:
    def __init__(self, service, providers=None):
        ...
        self.providers = providers or {
            "vnpy": VnpyAlphaSignalProvider(self.repo),
            "vnpy_reference": VnpyAlphaSignalProvider(self.repo, reference=True),
        }
    ...
    def generate(self, run_id, plan_window, as_of):
        ...
        require(primary == "vnpy" and shadow == "vnpy_reference",
                "LEGACY_STRATEGY_RETIRED", "旧策略实例仅保留历史记录，不能生成新计划", 409)
