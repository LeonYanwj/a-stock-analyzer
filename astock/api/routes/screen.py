...
from astock.api.errors import BadRequest

from astock.strategies import calc_optimal_top_n
from astock.api.schemas import ScreenResult
...
def run_screen_sync(
    ...
    """
    raise BadRequest("旧 screen.py 选股已停用；请使用 POST /api/market-scans 的 vn.py Alpha 策略。",
...
def list_strategies_api():
    """当前可用的选股策略。"""
    return {"strategies": ["vnpy_alpha101"]}
